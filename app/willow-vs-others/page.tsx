...
function ComparisonTableSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      subtitle: "Program-level personalized ROI & completion rates?",
      values: [
    ...
    {
      name: "Teaches AI Fluency & Literacy",
      subtitle: "",
      values: [
        {
          status: "check",
    ...
    },
    {
      ...
      values: [
        ...
        { status: "partial", note: "" },
        { status: "x", note: "" },
        { status: "check", note: "Optional third-party curriculum available for a higher cost." },
      ],
    },
  ];
